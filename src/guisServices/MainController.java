...
public class MainController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            Parent contentarea = FXMLLoader.load(getClass().getResource("/guis/ContentArea.fxml"));
    ...
    {   
        try {
            Parent contentusers = FXMLLoader.load(getClass().getResource("/guis/ContentArea.fxml"));
